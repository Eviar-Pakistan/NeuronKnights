...
export default function Intro4PR() {
    const router = useRouter();

    // Individual image requirements
    const image1 = require("../assets/images/hippavt.png");
    ...
    return (
        <SafeAreaView className="flex-1 w-full bg-white ">
            ...
            <View className="flex-row items-center z-10 justify-between px-4 py-2 bg-[#4a89dc]">
                ...
                <Text className="text-white text-center text-2xl font-bold">Tools for Growing{"\n"}
                    <Text className="text-white text-center text-2xl font-bold">Healthy Minds</Text>
                </Text>
                <View className="w-6" />
            </View>
